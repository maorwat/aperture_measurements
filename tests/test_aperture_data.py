...
class TestAperData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        line1 = '/eos/user/m/morwat/aperture_measurements/test_data/Martas_injection_b1.json'
    ...
    def test_aperture(self):
        ...
        path1 = '/eos/user/m/morwat/aperture_measurements/test_data/all_optics_B1.tfs'
        self.data.load_aperture(path1 = path1)
    ...
    def test_envelope(self):
        ...
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['sigma_y'].values[0], 0.00028429817383814163)
        self.assertEqual(self.data.tw_b2[self.data.tw_b2['name']=='ip2']['sigma_x'].values[0], 0.00027062576526564554)
    ...
    def test_knobs(self):
        ...
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['y'].values[0], 0.0020000105705815104)
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['x'].values[0], -8.854797816681602e-08)
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['x_from_nom_to_top'].values[0], -2.512337173648877e-05)
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['x_from_nom_to_bottom'].values[0], 2.512337173648877e-05)
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['y_from_nom_to_bottom'].values[0], -6.86575432574596e-06)
        self.assertEqual(self.data.tw_b1[self.data.tw_b1['name']=='ip5']['y_from_nom_to_top'].values[0], 6.86575432574596e-06)
        
    def test_collimators_and_elements(self):
        
        path = '/eos/user/m/morwat/aperture_measurements/test_data/injection.yaml'
        ...
        self.assertEqual(self.data.colx_b1[self.data.colx_b1['name']=='tcp.c6l7.b1']['gap'].values[0], 5.7)
        self.assertEqual(self.data.colx_b1[self.data.colx_b1['name']=='tcp.c6l7.b1']['top_gap_col'].values[0], 0.005777892163007533)
        self.assertEqual(self.data.colx_b1[self.data.colx_b1['name']=='tcp.c6l7.b1']['bottom_gap_col'].values[0], -0.005781499604695189)
        
        ind = self.data.coly_b2['name']=='tctpv.4r2.b2'
        
        self.assertEqual(self.data.coly_b2[ind]['y'].values[0]+self.data.coly_b2[ind]['gap'].values[0]*self.data.coly_b2[ind]['sigma_y'].values[0], self.data.coly_b2[ind]['top_gap_col'].values[0])
        
        path = '/eos/user/m/morwat/aperture_measurements/test_data/thick_all_optics_B1.tfs'
