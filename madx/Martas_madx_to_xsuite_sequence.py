...
line = xt.Line.from_madx_sequence(mad.sequence[sequence], apply_madx_errors=False, install_apertures=True, deferred_expressions=True)
...
print("Testing if Twiss can be generated")
t = newline.twiss()
